...
namespace AutoJungle.Data
{
    internal class ItemHandler
    {
        ...
        private void SetlistDr()
        {
            ...
            ItemList.Add(new BuyingOrder(8, 1001, "boost", 300));
            ItemList.Add(new BuyingOrder(9, 3111, "TreadsCost", 1100));
            ItemList.Add(new BuyingOrder(10, 3211, "Spectres Cow", 1200));
            ItemList.Add(new BuyingOrder(11, 3065, "Spirit Visage", 1600));
            ItemList.Add(new BuyingOrder(12, 1028, "Ruby Crystal", 400));
            ItemList.Add(new BuyingOrder(13, 1031, "Chain Vest", 800));
            ItemList.Add(new BuyingOrder(14, 3742, "Dead Man's Plate", 1800));
