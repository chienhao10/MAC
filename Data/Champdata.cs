...
namespace AutoJungle
{
    internal class Champdata
    {
        ...
        private bool DrCombo()
        {
            ...
            if (E.IsReady() && targetHero.IsValidTarget(150) || targetHero.MaxHealth > 5)
            {
                E.Cast();
            }
            OrbwalkingForBots.Orbwalk(targetHero);
        ...
        private bool DrJungleClear()
        {
            ...
            ItemHandler.UseItemsJungle();
            if (Q.IsReady() && Q.CanCast(targetMob) || targetMob.MaxHealth > 700)
            {
